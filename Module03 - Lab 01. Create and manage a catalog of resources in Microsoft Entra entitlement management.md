...
| Task 번호 | 작업 내용                                      | 주요 설정 및 설명                                                                 |
|-----------|-----------------------------------------------|-----------------------------------------------------------------------------------|
| Task 1    | Create a catalog                              | Microsoft Entra Entitlement Management에서 액세스 패키지를 구성하기 위한 리소스 묶음 생성. |
| Task 2    | Add resources to the catalog                  | 그룹, 애플리케이션, SharePoint 사이트 등을 해당 카탈로그에 포함.                       |
| Task 3    | Add additional catalog owners                 | 추가 관리자를 Catalog Owner로 지정하여 카탈로그 관리를 공동 수행.                       |
